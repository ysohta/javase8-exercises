...
public class WordLengthCounterImprovedTest {
	...
	public void testCountWordLengthsBelowUpperBoundary() {
		...
		int[] actuals = WordLengthCounterImproved.countWordLengthsBelow(words, 4);
	...
	public void testCountWordLengthsBelowRandomWord()
	{
		...
		int[] actuals = WordLengthCounterImproved.countWordLengthsBelow(words, maxLength);
	...
	public void testCountWordLengthsBelowNull() {
		WordLengthCounterImproved.countWordLengthsBelow(null, 0);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testCountWordLengthsBelowSmallerMaxLength() {
		WordLengthCounterImproved.countWordLengthsBelow(Stream.empty(), -1);
	}
