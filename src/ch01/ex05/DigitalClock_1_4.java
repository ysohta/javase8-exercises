...
public class DigitalClock_1_4 extends Frame {
	...
	public DigitalClock_1_4(String title) throws HeadlessException {
		super(title);
		initialize();
	...
	private void createMenu() {
		...
		menuView.add(prop);
		prop.addActionListener(new PropListener(this));
	...
	class PropListener implements ActionListener {
		...
		public PropListener(Frame owner) {
			this.owner = owner;
		}
